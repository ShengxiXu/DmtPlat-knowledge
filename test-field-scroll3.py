...
with sync_playwright() as p:
    ...
    # wrap renderTemplateCreator to log snapshot/restore
    page.evaluate('''() => {
        const orig = window.app.renderTemplateCreator.bind(window.app);
        window.app.renderTemplateCreator = function(...args) {
