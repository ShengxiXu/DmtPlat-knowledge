...
with sync_playwright() as p:
    ...
    page.evaluate('''() => {
        ...
        el.addEventListener('scroll', (e) => {
            console.log('SCROLL event', e.target.scrollTop, e.target.scrollHeight, e.target.clientHeight);
            console.trace();
        });
    }''')
    ...
    print('before click scroll', page.evaluate('document.querySelector(".wa-creator-form-config").scrollTop'))
